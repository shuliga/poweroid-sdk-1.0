...
const unsigned char ttable[5][4] = {
        ...
        // B_CW_BEGIN
        {R_START,  B_CW_NEXT | DIR_CW,  R_START, R_START},
        // B_CW_NEXT
        {B_CW_NEXT,  B_CW_NEXT, R_START,  R_START},
        // R_CCW_BEGIN
        {R_START, R_START, B_CCW_NEXT | DIR_CCW, R_START},
        // B_CCW_NEXT
        {B_CCW_NEXT, R_START, B_CCW_NEXT, R_START}
};
